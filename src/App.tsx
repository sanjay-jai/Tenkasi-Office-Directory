...
import { Search, Phone, Mail, MapPin, User, Loader2, RefreshCw, MessageCircle } from 'lucide-react';
    ...
    >
      ...
      <div className="space-y-2 border-t border-slate-100 pt-4 relative z-10">
        <div className="flex gap-2">
          <a 
            href={`tel:${off.mobile}`}
            className="flex-1 flex items-center gap-3 p-2 bg-slate-50 hover:bg-green-50 rounded-lg group/btn transition-colors"
          >
          ...
          <a 
            href={`https://wa.me/91${off.mobile.replace(/\D/g, '')}`}
            target="_blank"
            rel="noreferrer"
            className="w-12 h-12 flex items-center justify-center bg-[#25D366]/10 hover:bg-[#25D366] text-[#128C7E] hover:text-white rounded-xl transition-all border border-[#25D366]/20"
